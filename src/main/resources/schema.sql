...
CREATE TABLE news(id bigint IDENTITY PRIMARY KEY, title VARCHAR(50), description VARCHAR(250), created_date timestamp, last_modified_date timestamp, status VARCHAR(20));
CREATE TABLE topics(id bigint IDENTITY PRIMARY KEY, name VARCHAR(50), description VARCHAR(250), created_date timestamp, last_modified_date timestamp);
